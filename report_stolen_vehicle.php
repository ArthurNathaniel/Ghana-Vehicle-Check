...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Insert data into stolen_vehicles table
    $stmt = $conn->prepare("INSERT INTO stolen_vehicles (license_plate, stolen_date, report_details) VALUES (?, ?, ?)");
    $stmt->bind_param("sss", $license_plate, $stolen_date, $report_details);

    if ($stmt->execute()) {
        $success_message = "Vehicle reported as stolen successfully!";
    } else {
...
<head>
    ...
    <title>Report Stolen Vehicle</title>
    <?php include 'cdn.php'; ?>
...
<body>
    ...
    <div class="register_all">
        ...
        <form method="post" action="">
            <div class="headings">
                <h3>Search for License Plate</h3>
            </div>
            <div class="forms">
            ...
            <div class="forms">
                ...
                <input type="date" name="stolen_date" required>
            </div>
            <div class="forms">
            ...
            <div class="forms forms_submit">
                <button type="submit">Report Stolen Vehicle</button>
            </div>
        </form>
    </div>
